...
void prompt_subtraction(){

  //string histline;
  //ifstream in("histList_Subt.txt");
  // Line loop
  ...
  //  if(variable.Contains("Eta")) txt_variable = "#eta";
    ...
    TH1D *h_Data_LooseMuPtCone[3], *h_Data_TightMuPtCone[3], *h_MC_LooseMuPtCone[MCNumber][3], *h_MC_LooseMuPtCone_Norm[MCNumber][3], *h_MC_TightMuPtCone[MCNumber][3], *h_MC_TightMuPtCone_Norm[MCNumber][3];
    TH1D *h_Data_LooseMuPtCone_Subt[3], *h_Data_TightMuPtCone_Subt[3];
    ...
    for(int it_y=0; it_y<year.size(); it_y++){
      ...
      for(int it_mc=0; it_mc<MCNumber; it_mc++){
        ...
        for(int j=1; j<=20; j++){
          this_content_loose = h_MC_LooseMuPtCone[it_mc][it_y]->GetBinContent(j)*0.6798656507922819;
          this_content_tight = h_MC_TightMuPtCone[it_mc][it_y]->GetBinContent(j)*0.6798656507922819;
        ...
        for(int j=21; j<=30; j++){
          this_content_loose = h_MC_LooseMuPtCone[it_mc][it_y]->GetBinContent(j)*1.261913344446241;
          this_content_tight = h_MC_TightMuPtCone[it_mc][it_y]->GetBinContent(j)*1.261913344446241;
          h_MC_LooseMuPtCone_Norm[it_mc][it_y]->SetBinContent(j, this_content_loose);
          h_MC_TightMuPtCone_Norm[it_mc][it_y]->SetBinContent(j, this_content_tight);
        }
        for(int j=31; j<=1000; j++){
          this_content_loose = h_MC_LooseMuPtCone[it_mc][it_y]->GetBinContent(j)*0.93364342777285;
          this_content_tight = h_MC_TightMuPtCone[it_mc][it_y]->GetBinContent(j)*0.93364342777285;
          h_MC_LooseMuPtCone_Norm[it_mc][it_y]->SetBinContent(j, this_content_loose);
          h_MC_TightMuPtCone_Norm[it_mc][it_y]->SetBinContent(j, this_content_tight);
        }
      ...
      //  cout << "MC : " << h_MC_LooseMuPtCone[0][it_y]->GetBinContent(j) << endl;
      //  cout << "MC_Norm : " << h_MC_LooseMuPtCone_Norm[0][it_y]->GetBinContent(j) << endl;
      //  cout << "after : " <<  h_Data_LooseMuPtCone_Subt[it_y]->GetBinContent(j) << endl;
      //}
      //cout << h_Data_TightMuPtCone_Subt[it_y]->GetBinContent(j) << endl;
      ...
      //if(isNorm=="Norm") c1->SaveAs("./plots_Subt/"+channel+"_"+output_region+"_"+variable+"_"+IDname+"_"+year.at(it_y)+"_"+isNorm+".png");
      ...
      else if(isNorm=="Norm"&&variable.Contains("Mu17")) scale = 0.93364342777285;
