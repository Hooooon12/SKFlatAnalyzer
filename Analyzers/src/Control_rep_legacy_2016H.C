#include "Control_rep_legacy_2016H.h"

Control_rep_legacy_2016H::Control_rep_legacy_2016H(){

}

void Control_rep_legacy_2016H::initializeAnalyzer(){

  //==== if you use "--userflags RunSyst" with SKFlat.py, HasFlag("RunSyst") will return "true"
//  RunSyst = HasFlag("RunSyst");
//  cout << "[Control_rep_legacy_2016H::initializeAnalyzer] RunSyst = " << RunSyst << endl;
  ...
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/Control_rep_legacy_2016H.h 
...
//  cout << "[Control_rep_legacy_2016H::initializeAnalyzer] IsoMuTriggerName = " << IsoMuTriggerName << endl;
//  cout << "[Control_rep_legacy_2016H::initializeAnalyzer TriggerSafePtCut = " << TriggerSafePtCut << endl;
...
void Control_rep_legacy_2016H::executeEvent(){
  ...
  //==== So, I defined "vector<Muon> AllMuons;" in Analyzers/include/Control_rep_legacy_2016H.h,
...
//  AllFatJets = GetAllFatJets();
  ...
  //==== I defined "double weight_Prefire;" in Analyzers/include/Control_rep_legacy_2016H.h
...
void Control_rep_legacy_2016H::executeEventFromParameter(AnalyzerParameter param){
...
/*  if(param.syst_ == AnalyzerParameter::Central){
    ...
    cout << "[Control_rep_legacy_2016H::executeEventFromParameter] Wrong syst" << endl;
    exit(EXIT_FAILURE);
  }*/
