...
void HNL_LeptonCore::DefineBDTLimitBins(){
  ...
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_125"] = {-0.2 , -0.1 , -0.05 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.22 , 1}; //12
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_150"] = {-0.2 , -0.1 , -0.05 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 1}; //12
  map_bdt_limit_bins["SR3BDT_MuMu_2016preVFP_200"] = {-0.2 , -0.1 , -0.05 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 1}; //11
  ...
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_125"] = {-0.2 ,  -0.1 ,-0.05 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 1};  //12  
  map_bdt_limit_bins["SR3BDT_MuMu_2016postVFP_150"] = {-0.2 ,  -0.1 ,-0.05 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 1}; //12  
  ...
  map_bdt_limit_bins["SR3BDT_MuMu_2017_150"] = {-0.1 , -0.05 , 0 , 0.05 , 0.1 , 0.12 , 0.16 , 0.18 , 0.2 , 0.22 , 0.23 , 1};
  ...
  map_bdt_limit_bins["SR3BDT_MuMu_2018_85"]  = {-0.1 ,  0 , 0.05 , 0.1 ,  0.14 , 0.16 , 0.18 , 0.2 , 0.22 , 0.24 , 0.26 , 0.28 , 0.3 , 1};
  map_bdt_limit_bins["SR3BDT_MuMu_2018_90"]  = {-0.1 ,  0 , 0.05 , 0.1 ,  0.14 , 0.16 , 0.18 , 0.2 , 0.22 , 0.24 , 0.26 , 0.28 , 0.3 , 1};
  map_bdt_limit_bins["SR3BDT_MuMu_2018_95"]  = {-0.1 ,  0 , 0.05 , 0.1 ,  0.14 , 0.16 , 0.18 , 0.2 , 0.22 , 0.24 , 0.26 , 0.28 , 0.3 , 1};
  map_bdt_limit_bins["SR3BDT_MuMu_2018_100"] = {-0.1 ,  0 , 0.05 , 0.1 ,  0.14 , 0.16 , 0.18 , 0.2 , 0.22 , 0.24 , 0.26 , 0.28 , 0.3 , 1};
  map_bdt_limit_bins["SR3BDT_MuMu_2018_125"] = {-0.1 ,  0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 0.22 , 0.24 , 1};
  map_bdt_limit_bins["SR3BDT_MuMu_2018_150"] = {-0.1 ,  0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 0.22 , 0.24 , 1};
  ...
  map_bdt_limit_bins["SR3BDT_EE_2016postVFP_125"] = {-0.2 , -0.15 , -0.1 , 0 , 0.1 , 0.125 , 0.15 , 0.175 , 0.2 , 0.22 , 0.24 , 0.26 , 0.28 , 0.29 , 1};
  map_bdt_limit_bins["SR3BDT_EE_2016postVFP_150"] = {-0.2 , -0.15 , -0.1 , 0 , 0.05 , 0.075, 0.1 , 0.125 , 0.15 , 0.175 , 0.2 , 0.23 , 0.26 , 1};
  ...
  map_bdt_limit_bins["SR3BDT_EE_2018_125"] = {-0.2 , -0.1 , 0 , 0.05,  0.1 , 0.125 , 0.15 , 0.175 , 0.2 , 0.22 , 0.24 , 0.26 , 0.28 , 0.30 , 1};
  ...
  map_bdt_limit_bins["SR3BDT_EMu_2016postVFP_125"] = {-0.1 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 0.22 , 1};
  ...
  map_bdt_limit_bins["SR3BDT_EMu_2017_150"] = {-0.1 ,  0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 0.22 , 0.23 , 0.24 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2017_200"] = {-0.1 ,   0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 0.23 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2017_250"] = {-0.2 , -0.1 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 0.23 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2017_300"] = {-0.25 , -0.2 , -0.1 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2017_400"] = {-0.2 , -0.1 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2017_500"] = {-0.2, -0.2 , -0.1 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 1};

  map_bdt_limit_bins["SR3BDT_EMu_2018_85"]  = {-0.1 ,0 ,  0.1 ,  0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 0.22 , 0.23 , 0.24 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2018_90"]  = {-0.1 ,0 ,  0.1 ,  0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 0.22 , 0.23 , 0.24 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2018_95"]  = {-0.1 ,0 , 0.1 ,  0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 0.22 , 0.23 , 0.24 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2018_100"] = {-0.1 ,0 , 0.1 ,  0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 0.22 , 0.23 , 0.24 , 1};
  ...
  map_bdt_limit_bins["SR3BDT_EMu_2018_200"] = {-0.1 ,0 , 0.05 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 0.22 , 0.24 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2018_250"] = {-0.1 ,0 , 0.05 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 0.22 , 0.26 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2018_300"] = {-0.2, -0.1 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 0.21 , 1};
  map_bdt_limit_bins["SR3BDT_EMu_2018_400"] = {-0.2 , -0.1 , 0 , 0.05 , 0.1 , 0.12 , 0.14 , 0.16 , 0.18 , 0.2 , 1};
