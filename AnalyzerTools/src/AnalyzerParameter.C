...
TString AnalyzerParameter::GetSystType(){
  ...
  else if(syst_==Syst::FRMuonAJUp)       return "FRAJMuonUp";
  else if(syst_==Syst::FRMuonAJ40)  return "FRAJMuon40";
  else if(syst_==Syst::FRMuonAJDown)     return "FRAJMuonDown";
  else if(syst_==Syst::FRMuonLooseIDDJUp)     return "FRMuonIDUp";
  else if(syst_==Syst::FRMuonLooseIDDJDown)   return "FRMuonIDDown";
  else if(syst_==Syst::FRElectronAJUp)       return "FRAJElectronUp";
  else if(syst_==Syst::FRElectronAJ40)  return "FRAJElectron40";
  ...
  else if(syst_==Syst::JetAbsoluteStatUp) return "JetAbsoluteStatUp";
  else if(syst_==Syst::JetAbsoluteStatDown) return "JetAbsoluteStatDown";
  else if(syst_==Syst::JetAbsoluteScaleUp) return "JetAbsoluteScaleUp";
  else if(syst_==Syst::JetAbsoluteScaleDown) return "JetAbsoluteScaleDown";
  else if(syst_==Syst::JetAbsoluteMPFBiasUp) return "JetAbsoluteMPFBiasUp";
  else if(syst_==Syst::JetAbsoluteMPFBiasDown) return "JetAbsoluteMPFBiasDown";
  else if(syst_==Syst::JetFragmentationUp) return "JetFragmentationUp";
  else if(syst_==Syst::JetFragmentationDown) return "JetFragmentationDown";
  else if(syst_==Syst::JetSinglePionECALUp) return "JetSinglePionECALUp";
  else if(syst_==Syst::JetSinglePionECALDown) return "JetSinglePionECALDown";
  else if(syst_==Syst::JetSinglePionHCALUp) return "JetSinglePionHCALUp";
  else if(syst_==Syst::JetSinglePionHCALDown) return "JetSinglePionHCALDown";
  else if(syst_==Syst::JetFlavorQCDUp) return "JetFlavorQCDUp";
  else if(syst_==Syst::JetFlavorQCDDown) return "JetFlavorQCDDown";
  else if(syst_==Syst::JetTimePtEtaUp) return "JetTimePtEtaUp";
  else if(syst_==Syst::JetTimePtEtaDown) return "JetTimePtEtaDown";
  else if(syst_==Syst::JetRelativeJEREC1Up) return "JetRelativeJEREC1Up";
  else if(syst_==Syst::JetRelativeJEREC1Down) return "JetRelativeJEREC1Down";
  else if(syst_==Syst::JetRelativeJEREC2Up) return "JetRelativeJEREC2Up";
  else if(syst_==Syst::JetRelativeJEREC2Down) return "JetRelativeJEREC2Down";
  else if(syst_==Syst::JetRelativePtHFUp) return "JetRelativePtHFUp";
  else if(syst_==Syst::JetRelativePtHFDown) return "JetRelativePtHFDown";
  else if(syst_==Syst::JetRelativePtBBUp) return "JetRelativePtBBUp";
  else if(syst_==Syst::JetRelativePtBBDown) return "JetRelativePtBBDown";
  else if(syst_==Syst::JetRelativePtEC1Up) return "JetRelativePtEC1Up";
  else if(syst_==Syst::JetRelativePtEC1Down) return "JetRelativePtEC1Down";
  else if(syst_==Syst::JetRelativePtEC2Up) return "JetRelativePtEC2Up";
  else if(syst_==Syst::JetRelativePtEC2Down) return "JetRelativePtEC2Down";
  else if(syst_==Syst::JetRelativeBalUp) return "JetRelativeBalUp";
  else if(syst_==Syst::JetRelativeBalDown) return "JetRelativeBalDown";
  else if(syst_==Syst::JetRelativeSampleUp) return "JetRelativeSampleUp";
  else if(syst_==Syst::JetRelativeSampleDown) return "JetRelativeSampleDown";
  else if(syst_==Syst::JetRelativeFSRUp) return "JetRelativeFSRUp";
  else if(syst_==Syst::JetRelativeFSRDown) return "JetRelativeFSRDown";
  else if(syst_==Syst::JetRelativeStatFSRUp) return "JetRelativeStatFSRUp";
  else if(syst_==Syst::JetRelativeStatFSRDown) return "JetRelativeStatFSRDown";
  else if(syst_==Syst::JetRelativeStatECUp) return "JetRelativeStatECUp";
  else if(syst_==Syst::JetRelativeStatECDown) return "JetRelativeStatECDown";
  else if(syst_==Syst::JetRelativeStatHFUp) return "JetRelativeStatHFUp";
  else if(syst_==Syst::JetRelativeStatHFDown) return "JetRelativeStatHFDown";
  else if(syst_==Syst::JetPileUpDataMCUp) return "JetPileUpDataMCUp";
  else if(syst_==Syst::JetPileUpDataMCDown) return "JetPileUpDataMCDown";
  else if(syst_==Syst::JetPileUpPtRefUp) return "JetPileUpPtRefUp";
  else if(syst_==Syst::JetPileUpPtRefDown) return "JetPileUpPtRefDown";
  else if(syst_==Syst::JetPileUpPtBBUp) return "JetPileUpPtBBUp";
  else if(syst_==Syst::JetPileUpPtBBDown) return "JetPileUpPtBBDown";
  else if(syst_==Syst::JetPileUpPtEC1Up) return "JetPileUpPtEC1Up";
  else if(syst_==Syst::JetPileUpPtEC1Down) return "JetPileUpPtEC1Down";
  else if(syst_==Syst::JetPileUpPtEC2Up) return "JetPileUpPtEC2Up";
  else if(syst_==Syst::JetPileUpPtEC2Down) return "JetPileUpPtEC2Down";
  else if(syst_==Syst::JetPileUpPtHFUp) return "JetPileUpPtHFUp";
  else if(syst_==Syst::JetPileUpPtHFDown) return "JetPileUpPtHFDown";
  ...
  else if(syst_==Syst::RenScaleUp)     return "RenScaleUp";
  else if(syst_==Syst::RenScaleDown)   return "RenScaleDown";
  else if(syst_==Syst::FacScaleUp)     return "FacScaleUp";
  else if(syst_==Syst::FacScaleDown)   return "FacScaleDown";
