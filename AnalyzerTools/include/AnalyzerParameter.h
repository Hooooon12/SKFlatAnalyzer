...
class AnalyzerParameter{
 ...
 public:
  ...
  enum Syst{
    ...
    JetAbsoluteStatDown,
    JetAbsoluteScaleUp,
    JetAbsoluteScaleDown,
    JetAbsoluteMPFBiasUp,
    JetAbsoluteMPFBiasDown,
    JetFragmentationUp,
    JetFragmentationDown,
    JetSinglePionECALUp,
    JetSinglePionECALDown,
    JetSinglePionHCALUp,
    JetSinglePionHCALDown,
    JetFlavorQCDUp,
    JetFlavorQCDDown,
    JetTimePtEtaUp,
    JetTimePtEtaDown,
    JetRelativeJEREC1Up,
    JetRelativeJEREC1Down,
    JetRelativeJEREC2Up,
    JetRelativeJEREC2Down,
    JetRelativePtHFUp,
    JetRelativePtHFDown,
    JetRelativePtBBUp,
    JetRelativePtBBDown,
    JetRelativePtEC1Up,
    JetRelativePtEC1Down,
    JetRelativePtEC2Up,
    JetRelativePtEC2Down,
    JetRelativeBalUp,
    JetRelativeBalDown,
    JetRelativeSampleUp,
    JetRelativeSampleDown,
    JetRelativeFSRUp,
    JetRelativeFSRDown,
    JetRelativeStatFSRUp,
    JetRelativeStatFSRDown,
    JetRelativeStatECUp,
    JetRelativeStatECDown,
    JetRelativeStatHFUp,
    JetRelativeStatHFDown,
    JetPileUpDataMCUp,
    JetPileUpDataMCDown,
    JetPileUpPtRefUp,
    JetPileUpPtRefDown,
    ...
    BTagSFHTagUnCorrUp,BTagSFHTagUnCorrDown,    BTagSFLTagUnCorrUp,BTagSFLTagUnCorrDown,
    BTagSFHTagCorrUp,BTagSFHTagCorrDown,    BTagSFLTagCorrUp,BTagSFLTagCorrDown,
