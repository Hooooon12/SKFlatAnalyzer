...
# python MakeDataCard_ANv6.py --CR --Syst [--Decorr]; python MakeDataCard_ANv6.py --Combine CR --Syst [--Decorr] <-- add rateParam
# python MakeDataCard_ANv6.py --Combine Era --Syst [--Decorr]
# python MakeDataCard_ANv6.py --Syst [--Decorr]; python MakeDataCard_ANv6.py --Combine SR --Syst [--Decorr] <-- without rateParam ("sronly" setting)
