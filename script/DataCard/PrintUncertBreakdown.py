...
file_structure = [
    # 0. Total
    ("Total", "higgsCombine.Run2_MuMu_M10000_syst_s0_total.MultiDimFit.mH120.root"),
    # 1. Freeze Jet
    ("Freeze Jet", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet.MultiDimFit.mH120.root"),
    # 2. Freeze +Theory
    ("Freeze Theory", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet_theory.MultiDimFit.mH120.root"),
    # 3. Freeze +Fake
    ("Freeze Fake", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet_theory_fake.MultiDimFit.mH120.root"),
    # 4. Freeze +Lep
    ("Freeze Lep", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet_theory_fake_lep.MultiDimFit.mH120.root"),
    # 5. Freeze +Pileup
    ("Freeze Pileup", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet_theory_fake_lep_pileup.MultiDimFit.mH120.root"),
    # 6. Freeze +Lumi
    ("Freeze Lumi", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet_theory_fake_lep_pileup_lumi.MultiDimFit.mH120.root"),
    # 7. Freeze +Btag
    ("Freeze Btag", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet_theory_fake_lep_pileup_lumi_btag.MultiDimFit.mH120.root"),
    # 8. Freeze +Prefire
    ("Freeze Prefire", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire.MultiDimFit.mH120.root"),
    # 9. Freeze +Met
    ("Freeze MET", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met.MultiDimFit.mH120.root"),
    # 10. Freeze +Xsec
    ("Freeze Xsec", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec.MultiDimFit.mH120.root"),
    # 11. Stat Only (Freeze All)
    ("Stat Only", "higgsCombine.Run2_MuMu_M10000_syst_s0_freeze_all.MultiDimFit.mH120.root")
]
...
print("\nProcessing Uncertainty Breakdown...")
print("=" * 105)
