      ...
      with open(f"{WP}/{shortcard}/{this_check}/{AsimovName}/Run{this_check}_{AsimovName}.sh",'w') as runfile:
        ...
        for this_shortcard in list_shortcard:
          if args.FitDiag:
            ...
            # Keep the original scripts, just in case;
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert,pileup {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert,pileup,lumi {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert,pileup,lumi,btag_sf {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert,pileup,lumi,btag_sf,prefire {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert,pileup,lumi,btag_sf,prefire,met_energy {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert,pileup,lumi,btag_sf,prefire,met_energy,xsec {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert,pileup,lumi,btag_sf,prefire,met_energy,xsec,HEM {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec_HEM\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert,pileup,lumi,btag_sf,prefire,met_energy,xsec,HEM --freezeParameters 'rgx{{prop_bin.+}}' {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec_HEM_mcstat\n")
            #if "EE" in this_shortcard: runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeNuisanceGroups jet_uncert,theory,fake,lep_uncert,pileup,lumi,btag_sf,prefire,met_energy,xsec,HEM,cf --freezeParameters 'rgx{{prop_bin.+}}' {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec_HEM_mcstat_cf\n")
            #runfile.write(f"combine -M MultiDimFit higgsCombine.{this_shortcard}_{AsimovName}_saveWorkspace.MultiDimFit.mH120.root --algo grid --snapshotName MultiDimFit --setParameterRanges r={rRange['rMin']},{rRange['rMax']} --freezeParameters allConstrainedNuisances {AsimovSetting} --saveFitResult -n .{this_shortcard}_{AsimovName}_freeze_all\n")
            #if "EE" not in this_shortcard:
            #  runfile.write(f"plot1DScan.py higgsCombine.{this_shortcard}_{AsimovName}_total.MultiDimFit.mH120.root --main-label \"Total Uncert.\" --others higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet.MultiDimFit.mH120.root:\"jet\":4 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory.MultiDimFit.mH120.root:\"jet+theory\":5 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake.MultiDimFit.mH120.root:\"jet+theory+fake\":6 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep.MultiDimFit.mH120.root:\"jet+theory+fake+lep\":7 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup\":8 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi\":9 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag\":10 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire\":11 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire+met\":12 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire+met+xsec\":13 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec_HEM.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire+met+xsec+HEM\":14 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec_HEM_mcstat.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire+met+xsec+HEM+mcstat\":15 higgsCombine.{this_shortcard}_{AsimovName}_freeze_all.MultiDimFit.mH120.root:\"stat\":16 --output {this_shortcard}_{AsimovName}_Breakdown --y-max 10 --y-cut 40 --breakdown \"jet_uncert,theory,fake,lep_uncert,pileup,lumi,btag_sf,prefire,met_energy,xsec,HEM,mc_stat,rest,stat\"\n")
            #else:
            #  runfile.write(f"plot1DScan.py higgsCombine.{this_shortcard}_{AsimovName}_total.MultiDimFit.mH120.root --main-label \"Total Uncert.\" --others higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet.MultiDimFit.mH120.root:\"jet\":4 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory.MultiDimFit.mH120.root:\"jet+theory\":5 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake.MultiDimFit.mH120.root:\"jet+theory+fake\":6 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep.MultiDimFit.mH120.root:\"jet+theory+fake+lep\":7 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup\":8 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi\":9 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag\":10 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire\":11 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire+met\":12 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire+met+xsec\":13 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec_HEM.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire+met+xsec+HEM\":14 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec_HEM_mcstat.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire+met+xsec+HEM+mcstat\":15 higgsCombine.{this_shortcard}_{AsimovName}_freeze_jet_theory_fake_lep_pileup_lumi_btag_prefire_met_xsec_HEM_mcstat_cf.MultiDimFit.mH120.root:\"jet+theory+fake+lep+pileup+lumi+btag+prefire+met+xsec+HEM+mcstat+cf\":16 higgsCombine.{this_shortcard}_{AsimovName}_freeze_all.MultiDimFit.mH120.root:\"stat\":17 --output {this_shortcard}_{AsimovName}_Breakdown --y-max 10 --y-cut 40 --breakdown \"jet_uncert,theory,fake,lep_uncert,pileup,lumi,btag_sf,prefire,met_energy,xsec,HEM,mc_stat,cf,rest,stat\"\n")
